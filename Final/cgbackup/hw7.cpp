...
int main()
{
    ...
    // shaders
    Shader depthShader = Shader("resources/depth.vs", "resources/depth.fs");
    Shader cubeShader = Shader("resources/cube.vs", "resources/cube.fs");
    Shader lightShader = Shader("resources/light.vs", "resources/light.fs");
    ...
    {
        processInput(window, 0.05f, 0.5f, camera);
